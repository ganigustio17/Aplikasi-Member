            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-2xl">
                    <section>
                        ...
                        <form method="post" action="{{route('member.blog.update', ['post'=>$post->id])}}" class="mt-6 space-y-6" enctype="multipart/form-data">
                            ...
                            <div>
                                @isset($post->thumbnail)
                                    <img src="{{ asset('thumbnails/'. $post->thumbnail)}}" class="rounded-md border-gray-300 max-w-40 p-2" />
                                @endisset
                            ...
                            <div>
                                <input id="x"  type="hidden" value="{!! old('content', $post->content) !!}" name="content">
                            ...
                            <div class="flex items-center gap-4">
                                <a href="{{route('member.blog.index')}}">
